...
export default function TravelPlanContent() {
     ...
     *
     * We do NOT use a default/sample destination.
     */
...
function TripPlan({
        ...
        return (
            <main className="min-h-screen bg-[#f7f3ea]">
                <PageContainer>
                    ...
                    <section className="mx-auto w-full max-w-[1080px] px-1 py-16 sm:px-2">
                        <div className="rounded-[28px] border border-[#123c35]/10 bg-white p-8">
                            <div className="h-5 w-32 animate-pulse rounded bg-[#f7f3ea]" />

                            <div className="mt-4 h-10 w-72 animate-pulse rounded-lg bg-[#f7f3ea]" />

                            <div className="mt-3 h-4 w-96 max-w-full animate-pulse rounded bg-[#f7f3ea]" />

                            <div className="mt-8 grid gap-4 lg:grid-cols-2">
                                <div className="h-52 animate-pulse rounded-[24px] bg-[#f7f3ea]" />
                ...
                <PageContainer>
                    ...
                    <section className="mx-auto w-full max-w-[1080px] px-1 py-16 sm:px-2">
                        <div className="rounded-[28px] border border-[#123c35]/10 bg-white p-8">
                            ...
                            <p className="mt-3 max-w-xl text-sm leading-6 text-[#6d7974]">
                                {error}
                            </p>
                            ...
                            <button
                                ...
                                className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#123c35] px-5 py-3 text-sm font-black text-white"
                            >
                                <ArrowLeft className="h-4 w-4" />
                ...
                <PageContainer>
                    ...
                    <section className="mx-auto w-full max-w-[1080px] px-1 py-16 sm:px-2">
                        <div className="rounded-[28px] border border-[#123c35]/10 bg-white p-8">
                            ...
                            <p className="mt-3 text-sm text-[#6d7974]">
                                We couldn't find real information
                                for{" "}
                                <strong>
                                    {destinationQuery}
                                </strong>
                            ...
                            <button
                                ...
                                className="mt-6 rounded-full bg-[#123c35] px-5 py-3 text-sm font-black text-white"
                            >
    ...
    const maximumBudget = expenses.reduce(
        (total, expense) =>
                ...
                <section className="mx-auto w-full max-w-[1080px] px-1 pb-16 pt-5 sm:px-2 sm:pb-20 sm:pt-7">
                    ...
                    <div className="mb-5 flex items-center justify-between gap-3">
                        ...
                        <div className="hidden items-center gap-2 text-[10px] font-bold text-[#6d7974] sm:flex">
                            <span className="max-w-[220px] truncate rounded-full bg-white px-3 py-1.5">
                                {source || "Current location"}
                            </span>

                            <ArrowRight className="h-3.5 w-3.5 text-[#ef713d]" />

                            <span className="max-w-[220px] truncate rounded-full bg-[#e8f58d] px-3 py-1.5 text-[#123c35]">
                                {destination.name}
                            </span>
                        </div>
                    </div>
