    ...
    return (
        <article
            className="
                ...
                duration-300
                hover:-translate-y-1
                hover:shadow-[0_20px_55px_rgba(18,60,53,0.10)]
            "
        >
            {/* =====================================================
                IMAGE
                ...
                {food.imageUrl ? (
                    ...
                    <div
                        className="
                            ...
                            items-center
                            justify-center
                            bg-[radial-gradient(circle_at_20%_20%,rgba(232,245,141,0.45),transparent_30%),radial-gradient(circle_at_80%_70%,rgba(239,113,61,0.30),transparent_35%),linear-gradient(135deg,#06483f,#2d7768)]
                        "
                    >
                        <Utensils
                            className="
