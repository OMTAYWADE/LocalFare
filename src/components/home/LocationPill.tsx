...
export default function LocationPill({ location = "Mumbai, Maharashtra", onLocate,}: LocationPillProps) {
  return (
    <div className=" relative flex h-[58px] w-full max-w-[500px] items-center justify-between rounded-full bg-[#123c35] px-5 text-white shadow-[0_18px_45px_rgba(18,60,53,0.2)]">
