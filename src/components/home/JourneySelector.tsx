...
import { ArrowUpRight, Binoculars, ScanSearch, Send } from "lucide-react";
...
const options = [
  {
    ...
    description: "Discover attractions, food and useful places around you.",
    eyebrow: "Discover around you",
    icon: Binoculars,
    href: "/explore",
    cardClass: "bg-[#e8f58d] text-[#123c35]",
    iconClass: "bg-[#123c35] text-[#e8f58d]",
    arrowClass: "bg-[#cbe95b] text-[#123c35]",
  },
  {
    title: "I Know My Destination",
    description: "Compare routes, travel costs and options before you leave.",
    eyebrow: "Plan before you go",
    icon: Send,
    href: "/travel",
    cardClass: "bg-[#f8d4c1] text-[#123c35]",
    iconClass: "bg-[#ef713d] text-white",
    arrowClass: "bg-white/70 text-[#ef713d]",
  },
  {
    title: "Food & LocalFare",
    description: "Check food prices and local fare signals before you pay.",
    eyebrow: "Check before you pay",
    icon: ScanSearch,
    href: "/food",
    cardClass: "bg-[#123c35] text-white",
    iconClass: "bg-[#e8f58d] text-[#123c35]",
    arrowClass: "bg-white/10 text-[#e8f58d]",
  },
];

export default function JourneySelector({ compact = false }: JourneySelectorProps) {
