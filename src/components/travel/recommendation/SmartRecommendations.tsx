...
export default function SmartRecommendations({
    ...
    /*
     * No places received from API/database.
     */
        ...
        return (
            <section className="mt-14 rounded-[28px] border border-[#123c35]/10 bg-white p-6 sm:p-8">
                ...
                <p className="mt-2 max-w-xl text-sm leading-6 text-[#6d7974]">
                    We couldn't find any places around your
                    current location.
                </p>
    ...
    /*
     * The API/database has already supplied the places.
     *
     * This service only calculates their ranking.
     */
            ...
            <div className="mb-6">
                ...
                <div className="mt-2 flex flex-wrap items-end justify-between gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 max-w-xl text-sm leading-6 text-[#6d7974]">
                            We compare your budget, distance,
                            ratings, travel time and price signals
                            before ranking these places.
                        </p>

                    </div>

                    <div className="rounded-full bg-[#e8f58d] px-3 py-1.5 text-[10px] font-black text-[#123c35]">
                        {recommendations.length} places compared
                    </div>
